...
//        System.out.println(getTableNameByObject(new Student()));
//        System.out.println(getColumnNamesByObject(new Student()));
//        System.out.println(getColumnNameByFieldName("stuName"));
//        System.out.println(createSaveSqlByObject(new Student(314, "jack", "计算机","男",19,"长沙")));
//        System.out.println(createSelectByIdSqlByObject(new Student(314, "jack", "计算机","男",19,"长沙")));
//        System.out.println(new BaseDAO().selectById(new Student(314, null, null, null, null, null)));
//        System.out.println(new BaseDAO().selectById(new User(1, null, null, null)));
        System.out.println(createUpdateSqlByObject(new Student(314, "mark", "计算机","男",19,"长沙")));
    }
