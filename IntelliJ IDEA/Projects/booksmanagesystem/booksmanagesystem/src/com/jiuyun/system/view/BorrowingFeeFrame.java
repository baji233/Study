...
public class BorrowingFeeFrame extends JFrame {
    public BackBook backBook;
    public BorrowingFeeFrame(BackBook backBook) {
    ...
    private void initialBorrowingFeeFrame(){
        ...
        long payReceivable=BorrowingFeeDao.getReceivable(String.valueOf(backBook.field.get(r).get(12)));
        ...
        payButton.addActionListener(new BorrowingFeeActionListener(this));
