...
import com.jiuyun.system.control.MainBorrowListener;
import com.jiuyun.system.control.QuireListener;
...
public class MainFrame extends JFrame{
	...
	public void initialRightPnl() {
		...
		rightBtn[3].setActionCommand("borrowq");
		rightBtn[0].addActionListener(new MainBorrowListener());
		rightBtn[0].setActionCommand("borrow");
		rightBtn[1].addActionListener(new MainBorrowListener());
		rightBtn[1].setActionCommand("back");
		rightBtn[3].addActionListener(new MainBorrowListener());
