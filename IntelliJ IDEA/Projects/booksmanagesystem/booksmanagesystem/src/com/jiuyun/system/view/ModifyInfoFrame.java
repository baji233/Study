...
import com.jiuyun.system.control.ModifyListener;
...
public class ModifyInfoFrame extends JFrame{
	...
	public ModifyInfoFrame(BookInfoFrame bookInfoFrame) {
	...
	public void initialInfo() {
		...
		ModifyListener inpuLis=new ModifyListener(this);
	...
	public static void main(String[] args) {
		new ModifyInfoFrame().setVisible(true);
	}
}
